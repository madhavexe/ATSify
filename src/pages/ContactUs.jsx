...
const ContactUs = () => {
    return (
        <div class="bg-[url('./../public/Resume-BG.svg')]! bg-cover p-10 lg:px-15">
            <Navbar />

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 mb-16">

                <div class="space-y-8 bg-white rounded-2xl shadow-lg pl-10 pt-10">
                    <div>
                    ...
                    <div class="flex items-center space-x-6 mb-10 lg:mb-0">
                    ...
                    <form action="#" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="email" placeholder="Email" class="w-full px-4 py-3 rounded-md border-transparent bg-white" />
                            </div>
                            <div class="space-y-2">
                                <label class="block text-sm font-bold text-slate-900">Name</label>
                                <input type="text" placeholder="Name" class="w-full px-4 py-3 rounded-md border-transparent bg-white" />
                            </div>
                        </div>
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-900">Phone</label>
                            <input type="text" placeholder="Phone" class="w-full px-4 py-3 rounded-md border-transparent bg-white" />
                        </div>
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-900">Message</label>
                            <textarea rows="4" placeholder="Message" className="w-full px-4 py-3 rounded border border-black bg-white resize-none"></textarea>
                        </div>
            ...
            <div class="w-full h-[450px] border-2 border-black shadow-lg rounded-2xl overflow-hidden mb-16">
                <iframe
